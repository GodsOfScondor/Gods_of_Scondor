...
public abstract class ShaderProgram {
	...
	public ShaderProgram(String vertexFile, String fragmentFile) {
		...
		fragmentShaderID = loadShader(PATH + fragmentFile, GL20.GL_FRAGMENT_SHADER);
	...
	protected int getUniformLocation(String unifirmName) {
		return GL20.glGetUniformLocation(programID, unifirmName);
	}
